                        ...
                        <form method="post" enctype="multipart/form-data" action="/barang_keluar/store">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="email2">Nomor Barang keluar</label>
                                    <input type="text" value=" NBK-00<?php echo e($keluar->count()+1); ?>" readonly class="form-control" placeholder="Nomor Barang keluar" name="no_brg_keluar">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" placeholder="jumlah barang keluar" id="jml_brg_msk" name="jml_brg_keluar" required>
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="/barang_keluar" class="btn btn-danger">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\warning\resources\views//transaksi/barang_keluar/tambah.blade.php ENDPATH**/ ?>