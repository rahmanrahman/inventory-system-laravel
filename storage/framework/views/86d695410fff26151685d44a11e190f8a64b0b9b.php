    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="GET" action="/laporan_barang_retur/cetak_brg_retur" enctype="multipart/form-data" target="_blank">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-sm-12">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\warning\resources\views//laporan/brg_retur/lap_brg_retur.blade.php ENDPATH**/ ?>